...
class TownsControllerTest < ActionController::TestCase
  ...
  test "should create town" do
    assert_difference('Town.count') do
      post :create, town: { Code_Postal: @town.Code_Postal, latitude: @town.latitude, longitude: @town.longitude, name: @town.name }
    end
  ...
  test "should update town" do
    patch :update, id: @town, town: { Code_Postal: @town.Code_Postal, latitude: @town.latitude, longitude: @town.longitude, name: @town.name }
    assert_redirected_to town_path(assigns(:town))
  end
